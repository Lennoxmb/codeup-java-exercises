...
public class Practice {
    ...
    //12. In your Practice class, create a static method named multiplyAll. It should accept an integer and an ArrayList of integers. It should take the ArrayList argument and multiply all its elements by the value of the integer argument. It should return an ArrayList of integers.
    public static ArrayList<Integer> multiplyAll(int factor, ArrayList<Integer> numbers) {
